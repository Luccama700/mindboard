...
function CreateCourseForm({
  ...
  return (
    <form
      ...
      className="space-y-3 border border-hairline p-3"
    >
      <input
        autoFocus
        value={name}
              ...
              {sources.some((s) => s.status === "converted") && (
                <>
                  <Link
                    ...
                    className="inline-flex items-center min-h-11 px-3 text-action lowercase border border-hairline text-fg hover:border-line-strong transition-colors"
                  >
                    chat →
                  </Link>
                  <Link
